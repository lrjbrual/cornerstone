...
CREATE TABLE public.abouts (
    ...
    scriptures_title character varying,
    scriptures_body character varying,
    godhead_title character varying,
    godhead_body character varying,
    diety_title character varying,
    diety_body character varying,
    salvation_title character varying,
    salvation_body character varying,
    church_title character varying,
    church_body character varying,
    last_title character varying,
    last_body character varying,
    page_title character varying,
    page_notes character varying,
...
--
-- Name: sermons_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: sermons_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: sermons id; Type: DEFAULT; Schema: public; Owner: -
--
